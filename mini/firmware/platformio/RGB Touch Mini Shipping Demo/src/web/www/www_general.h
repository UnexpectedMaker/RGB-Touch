...
<html data-bs-theme="%THEME%">
    <head>
        <title>RGB Touch Mini Web Interface</title>
        %META%
    </head>
    <body>
        <div class="content" style="margin-top:12px;">
            <h2 class="center">RGB Touch Mini Web Interface</h2>
        ...
        <script
        src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.js"
...
const char footer[] PROGMEM = R"rawliteral(
		<div class="footer">
			<span>RGB Touch Mini - 2024 Unexpected Maker</span><br>
		</div>
