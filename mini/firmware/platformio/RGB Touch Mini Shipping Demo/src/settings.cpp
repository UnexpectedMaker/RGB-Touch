...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_WITH_DEFAULT(Config, wifi_start, wifi_options, current_wifi_station, wifi_check_for_updates, mdns_name, website_darkmode, city, country, utc_offset, orientation, brightness, volume, last_mode, current_effect, rotation_lock, deep_sleep_dimmer_USB, deep_sleep_dimmer_BAT);
